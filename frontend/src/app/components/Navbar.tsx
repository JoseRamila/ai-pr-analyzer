      ...
      <div className="mx-auto flex h-full max-w-3xl items-center justify-between px-6">
        <div className="flex items-center gap-2.5">
          ...
          <Badge
            ...
            style={{ backgroundColor: "rgba(99,102,241,0.15)", color: "#818cf8", border: "1px solid rgba(99,102,241,0.25)", borderRadius: "4px" }}
          >
            AI
          </Badge>
        </div>
        <nav className="flex items-center gap-1">
          {["Docs", "Changelog", "GitHub"].map((item) => (
            <button
              key={item}
              className="rounded-md px-3 py-1.5 transition-colors hover:bg-secondary"
              style={{ fontFamily: "'Inter', sans-serif", fontSize: "13px", color: "var(--muted-foreground)", fontWeight: 400 }}
            >
              {item}
            </button>
          ))}
          <div className="ml-2 flex items-center gap-1.5 rounded-md bg-secondary px-2.5 py-1.5">
            ...
            <span style={{ fontFamily: "'Geist Mono', monospace", fontSize: "11px", color: "var(--muted-foreground)", fontWeight: 500 }}>
              v1.0
            </span>
          </div>
        </nav>
